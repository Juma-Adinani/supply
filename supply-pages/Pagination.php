...
<!-- Mirrored from demo.dashboardpack.com/hospital-html/Pagination.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Apr 2023 16:55:03 GMT -->
...
<body class="crm_body_bg">
    ...
    <nav class="sidebar">
        <div class="logo d-flex justify-content-between">
            <a href="index-2.html"><img src="../resources/img/logo.png" alt=""></a>
        ...
        <ul id="sidebar_menu">
            ...
            <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
                    <img src="../resources/img/menu-icon/2.svg" alt="">
                    <span>Pages</span>
                </a>
                <ul>
            ...
            <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
                    <img src="../resources/img/menu-icon/3.svg" alt="">
                    <span>Applications</span>
                </a>
                <ul>
            ...
            <li class="mm-active">
                <a class="has-arrow" href="#" aria-expanded="false">
                    <img src="../resources/img/menu-icon/4.svg" alt="">
                ...
                <ul>
                    ...
                    <li class="mm-active"><a href="#">Components</a>
                        <ul>
                            <li><a href="notification.html">Notifications</a></li>
                            <li><a href="progress.html">Progress Bar</a></li>
                            <li><a href="carousel.html">Carousel</a></li>
                            <li><a href="cards.html">cards</a></li>
                            <li><a class="active" href="Pagination.html">Pagination</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
                    <img src="../resources/img/menu-icon/5.svg" alt="">
                    <span>Widgets</span>
                </a>
                <ul>
            ...
            <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
                    <img src="../resources/img/menu-icon/6.svg" alt="">
                    <span>Forms</span>
                </a>
                <ul>
                    <li><a href="#">Elements</a>
            ...
            <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
                    <img src="../resources/img/menu-icon/7.svg" alt="">
                    <span>Charts</span>
                </a>
                <ul>
